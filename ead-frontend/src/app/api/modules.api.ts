...
import { CourseRequest, CourseResponse, Page } from '../interfaces/courses.interface';
...
export class ModulesApi {
  ...
  public getAllModules(courseId: string): Observable<Page<ModuleResponse>> {
    return this.http.get<Page<ModuleResponse>>(`${this.apiBaseUrl}/${courseId}/modules`);
  }
